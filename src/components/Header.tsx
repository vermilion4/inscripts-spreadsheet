...
const Header = () => {
  ...
  const handleBreadcrumbClick = (path: string) => {
    setActivePath(path)
    alert('Navigating to breadcrumb')
  }
  ...
  return (
    <>
      <header className={`h-14 px-4 py-2 bg-white flex items-center ${(isSearchExpanded || isMobileMenuOpen) ? '' : 'border-b'} border-borderTertiary relative `}>
        <div className='flex items-center justify-between w-full gap-2 lg:gap-4'>
          ...
          <div className='flex items-center gap-2 lg:gap-4 min-w-0 flex-1'>
            ...
            <div className='hidden lg:flex items-center gap-2 text-sm leading-tight font-medium min-w-0'>
              ...
              <Dropdown
                trigger={<img src={ellipsis} alt="ellipsis" className='ml-2 cursor-pointer flex-shrink-0' />}
            ...
            <div className='flex lg:hidden items-center gap-2 text-sm leading-tight font-medium min-w-0 flex-1'>
              ...
              <Dropdown
                trigger={<img src={ellipsis} alt="ellipsis" className='ml-1 cursor-pointer flex-shrink-0' />}
                items={ellipsisMenuItems}
                position="bottom"
                width="w-40"
              />
          ...
          <div className='flex items-center gap-2 flex-shrink-0'>
            ...
            {/* Profile - Responsive */}
            <Tooltip content="john.doe@example.com" position="bottom" className='hidden sm:block'>
              <div className='flex items-center gap-2 h-10'>
                ...
                <div className='max-w-14 xl:max-w-20'>
                  ...
                  <p className='truncate text-xxs text-tertiary leading-none mt-0.5'>john.doe@example.com</p>
                </div>
              </div>
            </Tooltip>
            ...
            >
              {isMobileMenuOpen ? <FiX className='w-5 h-5 text-tertiary' /> : <FiMenu className='w-5 h-5 text-tertiary' />}
            </button>
          </div>
        </div>
      </header>
        ...
        <div className='sm:hidden absolute top-14 left-0 right-0 bg-white border-b border-borderTertiary z-50'>
          <div className='p-4 space-y-4'>
            ...
            <div className='flex flex-col gap-2'>
              <h3 className='text-xs font-medium text-tertiary uppercase tracking-wider'>Navigation</h3>
